...
@Index("z_sppt_perubahan_pkey", ["kdBlok", "kdDati2", "kdJnsOp", "kdKecamatan", "kdKelurahan", "kdPropinsi", "noUrut", "thnPajakSppt"], { unique: true })
@Entity("z_sppt_perubahan", { schema: "public" })
export class ZSpptPerubahan {
  ...
  @Column("smallint", { name: "perubahan_sppt_ke", nullable: true })
  perubahanSpptKe!: number | null;
  ...
  @Column("timestamp without time zone", { name: "tgl_cetak_sppt" })
  tglCetakSppt!: Date;
  ...
  @Column("timestamp without time zone", {
    name: "tgl_rekam_sppt_perubahan",
    nullable: true,
    default: () => "statement_timestamp()",
  })
  tglRekamSpptPerubahan!: Date | null;

  @Column("character", {
    name: "nip_rekam_sppt_perubahan",
    nullable: true,
    length: 18,
  })
  nipRekamSpptPerubahan!: string | null;

  @Column("character varying", {
    name: "status_data",
    nullable: true,
    length: 100,
    default: () => "'PERUBAHAN TSL'",
  })
