...
@Index("bng_sin_gas_fk", ["kdBlok", "kdDati2", "kdJnsOp", "kdKecamatan", "kdKelurahan", "kdPropinsi", "noBng", "noUrut"], {})
@Index("gas_pkey", ["noPelangganGas"], { unique: true })
@Entity("gas", { schema: "public" })
export class Gas {
