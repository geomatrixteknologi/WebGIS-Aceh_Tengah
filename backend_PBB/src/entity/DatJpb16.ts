...
@Index("dat_jpb16_pkey", ["kdBlok", "kdDati2", "kdJnsOp", "kdKecamatan", "kdKelurahan", "kdPropinsi", "noBng", "noUrut"], { unique: true })
@Entity("dat_jpb16")
export class DatJpb16 {
  ...
  @Column("character", { name: "kls_jpb16", length: 1 })
  klsJpb16!: string;

  @OneToOne(() => DatOpBangunan, (datOpBangunan) => datOpBangunan.datJp13)
  @JoinColumn([
