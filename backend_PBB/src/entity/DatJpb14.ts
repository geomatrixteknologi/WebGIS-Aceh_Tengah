...
@Index("dat_jpb14_pkey", ["kdBlok", "kdDati2", "kdJnsOp", "kdKecamatan", "kdKelurahan", "kdPropinsi", "noBng", "noUrut"], { unique: true })
@Entity("dat_jpb14", { schema: "public" })
export class DatJpb14 {
  ...
  @Column("bigint", { name: "luas_kanopi_jpb14" })
  luasKanopiJpb14!: string;

  @OneToOne(() => DatOpBangunan, (datOpBangunan) => datOpBangunan.datJp11)
  @JoinColumn([
