...
@Index("dat_jpb12_pkey", ["kdBlok", "kdDati2", "kdJnsOp", "kdKecamatan", "kdKelurahan", "kdPropinsi", "noBng", "noUrut"], { unique: true })
@Entity("dat_jpb12", { schema: "public" })
export class DatJpb12 {
  ...
  @Column("character", { name: "type_jpb12", length: 1 })
  typeJpb12!: string;

  @OneToOne(() => DatOpBangunan, (datOpBangunan) => datOpBangunan.datJpb)
  @JoinColumn([
