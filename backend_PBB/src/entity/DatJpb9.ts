...
@Index("dat_jpb9_pkey", ["kdBlok", "kdDati2", "kdJnsOp", "kdKecamatan", "kdKelurahan", "kdPropinsi", "noBng", "noUrut"], { unique: true })
@Entity("dat_jpb9", { schema: "public" })
export class DatJpb9 {
  ...
  @Column("character", { name: "kls_jpb9", length: 1 })
  klsJpb9!: string;

  @OneToOne(() => DatOpBangunan, (datOpBangunan) => datOpBangunan.datJpb9)
  @JoinColumn([
